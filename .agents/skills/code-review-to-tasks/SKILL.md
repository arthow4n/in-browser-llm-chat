...
1. **Perform Code Review**:
   - Apply the [code-review](../code-review/SKILL.md) skill to review the code or workspace.
   - Output the results to a findings and planned fix file in `docs/` (e.g., `docs/code-review-findings-<date>.md`).

2. **Break Down Plan into Tasks**:
   - Apply the [breakdown-plan](../breakdown-plan/SKILL.md) skill to the findings and planned fix file.
   - Generate a detailed, sequential, and actionable implementation checklist.
...
3. **Review Implementation Tasks**:
   - Apply the [review-implementation-tasks](../review-implementation-tasks/SKILL.md) skill to verify and refine the generated implementation tasks file.
